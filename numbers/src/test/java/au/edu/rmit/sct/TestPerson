...
class TestDemerits{
    ...
    //TestCase 1: Checks if offence date is in correct format.
        Person testCase1 = new Person("56s_d%&fAB", "John", "Doe", "15-11-1990", "2025-06-01", 3.0f);
    ...
    //TestCase 2: Checks if demerit points are whole numbers. 
        Person testCase2 = new Person("56s_d%&fAB", "John", "Doe", "15-11-1990", "01-06-2005", 3.5f);
    ...
    Person testCase3 = new Person("56s_d%&fAB", "John", "Doe", "15-11-1990", "01-06-2025", 7.0f);
    ...
    //TestCase 4: Checks if over demerit points for under 21.
        Person testCase4 = new Person("56s_d%&fAB", "John", "Doe", "15-11-2005", "25-04-2024", 5.0f);
    ...
    //TestCase 5: Checks if over demerit points for under 21 within 2 years.
        Person testCase5 = new Person("56s_d%&fAB", "John", "Doe", "15-11-2005", "01-06-2025", 3.0f);
